...
export class BrawlerService {
     ...
     */
    public getAllBrawlers(observe?: 'body', reportProgress?: boolean): Observable<Array<Brawler>>;
    public getAllBrawlers(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Brawler>>>;
    public getAllBrawlers(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Brawler>>>;
    public getAllBrawlers(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Brawler>>(`${this.basePath}/brawlers`,
            {
